...
%     end
    ...
    for c = 1:len(2)
        ...
        dataFileL = [Tire_name_list{tire_ind} ' - Contact - ' 'Left- ' int2str(test_pressures(c)) 'psi ' '.xlsx'];
        dataFileR = [Tire_name_list{tire_ind} ' - Contact - ' 'Right- ' int2str(test_pressures(c)) 'psi ' '.xlsx']; 
